      ...
      <div className="relative z-10 max-w-[1240px] mx-auto w-full flex flex-col h-full flex-1">
        ...
        <div className="flex items-center justify-between w-full">
          <span className="hidden md:flex font-mono text-[0.7rem] tracking-[0.15em] uppercase text-cream/40">
            Software Development Company — Africa & Beyond
          </span>
        ...
        <div className="mt-auto pt-10">
          ...
          >
            We Build
            <br />
            <em className="not-italic font-light text-orange">Software</em> That
            <br />
            <span className="text-lime">Scales.</span>
          </h1>

          <div className="flex flex-wrap items-start justify-between gap-10">
            <p className="text-[1.05rem] font-light text-cream/50 max-w-[420px] leading-[1.75]">
              PragDev crafts custom web apps, mobile products, and cloud
              solutions — transforming ambitious ideas into revenue-generating
