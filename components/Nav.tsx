      ...
      >
        <div className="flex items-center justify-between h-[72px] w-full max-w-[1240px] mx-auto">
          ...
          <Link href="#" className="flex items-center gap-2.5 no-underline group">
            <div className="w-auto h-auto px-3 py-2 bg-orange rounded-[7px] flex items-center justify-center text-[11px] font-mono font-extrabold text-white transition-transform duration-300 rotate-[-8deg] group-hover:scale-105">
              PragDev
            </div>
